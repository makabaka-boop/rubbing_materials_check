import { Plus, RotateCcw, ClipboardCheck, ListFilter, ArrowRightLeft, ClipboardList } from 'lucide-react'
...
export function Toolbar({ onAddClick, onTransferClick, onCheckTaskClick }: ToolbarProps) {
  ...
  const ongoingCheckTasks = checkTasks.filter((t) => t.status === '进行中').length
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="inline-flex items-center gap-1.5 px-4 py-2 bg-vermilion text-paper rounded-lg text-sm font-medium hover:bg-vermilion/90 transition-colors shadow-md shadow-vermilion/20"
          >
